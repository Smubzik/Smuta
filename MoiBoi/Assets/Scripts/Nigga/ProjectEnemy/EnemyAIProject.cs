...
[SelectionBase]
public class EnemyAIProject : MonoBehaviour
{
    ...
    private void MovingDirectionHandler()
    {
        if (Time.time > _nextCheckDirectionTime)
        {
            ...
            {
                ChangeFacingDirection(transform.position, Train.Instance.transform.position);
            }
    ...
    {
        _navMeshAgent.SetDestination(Train.Instance.transform.position);
    }
    ...
    {
        float distanceToPlayer = Vector3.Distance(transform.position, Train.Instance.transform.position);
